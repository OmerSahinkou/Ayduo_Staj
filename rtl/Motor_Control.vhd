...
begin
    ...
    -- =====================================================================
    -- MPU6500 UART Shift (Hassasiyet) Ayarları
    -- =====================================================================
    ...
    -- X ve Y doğrudan UART'tan gelen shift_accel ile kaydırılıyor
    ...
    -- Z ekseni tam dönsün diye +5 olan değer +2 yapıldı (Katsayı 8 kat artırıldı)
    hesap_temp_z <= to_signed(127, 16) + resize(shift_right(angle_pool, shift_gyro + 3), 16);
