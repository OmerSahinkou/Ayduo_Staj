...
// Git hash  : 426f299c84efe56878820dc408c75dd1a08df1c5
...
module EfxSapphireSoc (
  ...
  assign io_apbSlave_0_input_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_fragment_source = system_bmbPeripheral_bmb_withoutMask_cmd_payload_fragment_source_4;
  ...
  assign system_bmbPeripheral_bmb_withoutMask_rsp_payload_fragment_source_4 = io_apbSlave_0_input_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_source;
...
module BmbUartCtrl (
  ...
  always @(posedge io_systemClk) begin
    if(systemCd_logic_outputReset) begin
      ...
      bridge_uartConfigReg_clockDivider <= 20'h00022;
...
module BmbDecoder_3 (
  ...
  output wire [0:0]    io_outputs_5_cmd_payload_fragment_source,
