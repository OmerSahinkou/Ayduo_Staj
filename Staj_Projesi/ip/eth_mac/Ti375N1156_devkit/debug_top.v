...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  vio0_pma_cmn_ready,
    input  vio0_l0_sync_status,
    input  vio0_l3_sync_status,
    input  vio0_l0_init_done,
    input  vio0_l3_init_done,
    input  vio0_pll_locked,
    input  vio0_l0_rx_signal_detect,
    input  vio0_l3_rx_signal_detect,
    input  [7:0] vio0_l0_data_cnt,
    input  [7:0] vio0_l0_err_cnt,
    input  [7:0] vio0_l0_frame_cnt,
    input  [7:0] vio0_l0_bad_frame_cnt,
    input  [7:0] vio0_l3_data_cnt,
    input  [7:0] vio0_l3_err_cnt,
    input  [7:0] vio0_l3_frame_cnt,
    input  [7:0] vio0_l3_bad_frame_cnt,
    input  [23:0] vio0_ram_dout_a,
    input  [31:0] vio0_ram_dout_d,
    input  [1:0] vio0_l0_sgmii_speed,
    input  vio0_l0_speed_chg_active,
    input  [1:0] vio0_l3_sgmii_speed,
    input  vio0_l3_speed_chg_active,
    output vio0_usr_apb_start,
    output vio0_usr_apb_write,
    output [23:0] vio0_usr_apb_addr,
    output [31:0] vio0_usr_apb_pwdata
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 22 ),
        .NUM_PROBE_OUT          ( 4 ),
        .UUID           ( 128'h149e8dfda3984b55a91e34ad29b651db ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 1 ),
        .PROBE_IN2_WIDTH        ( 1 ),
        .PROBE_IN3_WIDTH        ( 1 ),
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_pma_cmn_ready ),
        .probe_in1          ( vio0_l0_sync_status ),
        .probe_in2          ( vio0_l3_sync_status ),
        .probe_in3          ( vio0_l0_init_done ),
        .probe_in4          ( vio0_l3_init_done ),
        .probe_in5          ( vio0_pll_locked ),
        .probe_in6          ( vio0_l0_rx_signal_detect ),
        .probe_in7          ( vio0_l3_rx_signal_detect ),
        .probe_in8          ( vio0_l0_data_cnt ),
        .probe_in9          ( vio0_l0_err_cnt ),
        .probe_in10         ( vio0_l0_frame_cnt ),
        .probe_in11         ( vio0_l0_bad_frame_cnt ),
        .probe_in12         ( vio0_l3_data_cnt ),
        .probe_in13         ( vio0_l3_err_cnt ),
        .probe_in14         ( vio0_l3_frame_cnt ),
        .probe_in15         ( vio0_l3_bad_frame_cnt ),
        .probe_in16         ( vio0_ram_dout_a ),
        .probe_in17         ( vio0_ram_dout_d ),
        .probe_in18         ( vio0_l0_sgmii_speed ),
        .probe_in19         ( vio0_l0_speed_chg_active ),
        .probe_in20         ( vio0_l3_sgmii_speed ),
        .probe_in21         ( vio0_l3_speed_chg_active ),
        .probe_in22         ( 1'b0 ),
        .probe_in23         ( 1'b0 ),
        .probe_in24         ( 1'b0 ),
        .probe_in25         ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( vio0_usr_apb_start ),
        .probe_out1         ( vio0_usr_apb_write ),
        .probe_out2         ( vio0_usr_apb_addr ),
        .probe_out3         ( vio0_usr_apb_pwdata ),
        .probe_out4         (  ),
        .probe_out5         (  ),
        .probe_out6         (  ),
        .probe_out7         (  ),
