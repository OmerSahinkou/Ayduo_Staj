...
# ---------------------------------------------------------
# 2. MOTOR GÖRSELLEŞTİRME BİLEŞENİ
# ---------------------------------------------------------
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Hızlandırmak için antialias kapalı tutulabilir, ancak modern sistemlerde açık kalması göze hoş gelir
        ...
        self.curve_ax = self.plot_acc.plot(pen=pen_raw_x, name="Acc X")
        self.curve_f_ax = self.plot_acc.plot(pen=pen_fil_x, name="Filt Acc X")
        self.curve_ay = self.plot_acc.plot(pen=pen_raw_y, name="Acc Y")
        self.curve_f_ay = self.plot_acc.plot(pen=pen_fil_y, name="Filt Acc Y")
        self.curve_az = self.plot_acc.plot(pen=pen_raw_z, name="Acc Z")
        self.curve_f_az = self.plot_acc.plot(pen=pen_fil_z, name="Filt Acc Z")
        ...
        self.curve_gx = self.plot_gyro.plot(pen=pen_raw_x, name="Gyro X")
        self.curve_f_gx = self.plot_gyro.plot(pen=pen_fil_x, name="Filt Gyro X")
        self.curve_gy = self.plot_gyro.plot(pen=pen_raw_y, name="Gyro Y")
        self.curve_f_gy = self.plot_gyro.plot(pen=pen_fil_y, name="Filt Gyro Y")
        self.curve_gz = self.plot_gyro.plot(pen=pen_raw_z, name="Gyro Z")
        self.curve_f_gz = self.plot_gyro.plot(pen=pen_fil_z, name="Filt Gyro Z")
        ...
        self.btn_send.setStyleSheet("background-color: #2a82da; color: white; font-weight: bold; padding: 10px; border-radius: 5px;")
        ...
        # GUI GÜNCELLEME ZAMANLAYICISI (Saniyede ~30 FPS çizer, çökmeyi engeller)
        self.gui_timer = QTimer()
        self.gui_timer.timeout.connect(self.refresh_gui)
        self.gui_timer.start(33) # 33 ms = ~30 FPS
    ...
    # Artık bu fonksiyon grafikleri ÇİZMİYOR, sadece verileri listeye atıyor.
    ...
    # QTimer tarafından çağırılıp grafikleri güncelleyen fonksiyon
    def refresh_gui(self):
        ...
        self.motor_view.update_angles(self.data['angx'][-1], self.data['angy'][-1], self.data['angz'][-1])
